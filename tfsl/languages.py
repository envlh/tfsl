...
langs.aa_ = Language("aa", "Afar")  # Afar
langs.ab_ = Language("ab", "Abkhazian")  # Abkhazian
langs.abs_ = Language("abs", "Ambonese Malay")  # Ambonese Malay
langs.ace_ = Language("ace", "Achinese")  # Achinese
langs.ady_ = Language("ady", "Adyghe")  # Adyghe
langs.ady_cyrl_ = Language("ady-cyrl", "Adyghe (Cyrillic script)")  # Adyghe (Cyrillic script)
langs.aeb_ = Language("aeb", "Tunisian Arabic")  # Tunisian Arabic
langs.aeb_arab_ = Language("aeb-arab", "Tunisian Arabic (Arabic script)")  # Tunisian Arabic (Arabic script)
langs.aeb_latn_ = Language("aeb-latn", "Tunisian Arabic (Latin script)")  # Tunisian Arabic (Latin script)
...
langs.be_x_old_ = Language("be-x-old", "Belarusian (Taraškievica orthography)")  # Belarusian (Taraškievica orthography)
...
langs.crh_ = Language("crh", "Crimean Tatar")  # Crimean Tatar
langs.crh_cyrl_ = Language("crh-cyrl", "Crimean Tatar (Cyrillic script)")  # Crimean Tatar (Cyrillic script)
langs.crh_latn_ = Language("crh-latn", "Crimean Tatar (Latin script)")  # Crimean Tatar (Latin script)
...
langs.gan_ = Language("gan", "Gan Chinese")  # Gan Chinese
langs.gan_hans_ = Language("gan-hans", "Gan (Simplified)")  # Gan (Simplified)
langs.gan_hant_ = Language("gan-hant", "Gan (Traditional)")  # Gan (Traditional)
...
langs.kk_arab_ = Language("kk-arab", "Kazakh (Arabic script)")  # Kazakh (Arabic script)
langs.kk_cn_ = Language("kk-cn", "Kazakh (China)")  # Kazakh (China)
langs.kk_cyrl_ = Language("kk-cyrl", "Kazakh (Cyrillic script)")  # Kazakh (Cyrillic script)
langs.kk_kz_ = Language("kk-kz", "Kazakh (Kazakhstan)")  # Kazakh (Kazakhstan)
langs.kk_latn_ = Language("kk-latn", "Kazakh (Latin script)")  # Kazakh (Latin script)
...
langs.ku_ = Language("ku", "Kurdish")  # Kurdish
langs.ku_arab_ = Language("ku-arab", "Kurdish (Arabic script)")  # Kurdish (Arabic script)
langs.ku_latn_ = Language("ku-latn", "Kurdish (Latin script)")  # Kurdish (Latin script)
...
langs.ruq_ = Language("ruq", "Megleno-Romanian")  # Megleno-Romanian
langs.ruq_cyrl_ = Language("ruq-cyrl", "Megleno-Romanian (Cyrillic script)")  # Megleno-Romanian (Cyrillic script)
langs.ruq_latn_ = Language("ruq-latn", "Megleno-Romanian (Latin script)")  # Megleno-Romanian (Latin script)
...
langs.shi_ = Language("shi", "Tachelhit")  # Tachelhit
langs.shi_latn_ = Language("shi-latn", "Tachelhit (Latin script)")  # Tachelhit (Latin script)
langs.shi_tfng_ = Language("shi-tfng", "Tachelhit (Tifinagh script)")  # Tachelhit (Tifinagh script)
...
langs.ug_ = Language("ug", "Uyghur")  # Uyghur
langs.ug_arab_ = Language("ug-arab", "Uyghur (Arabic script)")  # Uyghur (Arabic script)
langs.ug_latn_ = Language("ug-latn", "Uyghur (Latin script)")  # Uyghur (Latin script)
langs.uz_ = Language("uz", "Uzbek")  # Uzbek
langs.uz_cyrl_ = Language("uz-cyrl", "Uzbek (Cyrillic script)")  # Uzbek (Cyrillic script)
langs.uz_latn_ = Language("uz-latn", "Uzbek (Latin script)")  # Uzbek (Latin script)
...
langs.zh_hk_ = Language("zh-hk", "Chinese (Hong Kong)")  # Chinese (Hong Kong)
langs.zh_min_nan_ = Language("zh-min-nan", "Chinese (Min Nan)")  # Chinese (Min Nan)
langs.zh_mo_ = Language("zh-mo", "Chinese (Macau)")  # Chinese (Macau)
langs.zh_my_ = Language("zh-my", "Chinese (Malaysia)")  # Chinese (Malaysia)
langs.zh_sg_ = Language("zh-sg", "Chinese (Singapore)")  # Chinese (Singapore)
