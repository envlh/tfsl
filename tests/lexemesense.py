...
class TestSenseMethods(unittest.TestCase):
    ...
    def test_lexemesense_add_gloss(self):
        ...
        self.assertCountEqual(x.glosses, glosslist)
        self.assertCountEqual(y.glosses, [glosslist[0], glosslist[1], self.value_mt1])
    ...
    def test_lexemesense_add_statement(self):
        ...
        self.assertCountEqual(y.glosses, glosslist)
    ...
    def test_lexemesense_remove_gloss(self):
        ...
        self.assertCountEqual(x.glosses, glosslist)
        self.assertCountEqual(y.glosses, [glosslist[0]])
        self.assertEqual(y.statements, {self.property: [stmtlist[0]]})
    ...
    def test_lexemesense_overwrite_gloss(self):
        ...
        self.assertCountEqual(x.glosses, glosslist)
        self.assertCountEqual(y.glosses, [glosslist[0], self.rep3])
        self.assertEqual(y.statements, {self.property: [stmtlist[0]]})        
